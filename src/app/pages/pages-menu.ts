...
export const MENU_ITEMS: NbMenuItem[] = [
  ...
  // },
  {
    ...
    children: [
      ...
      {
        title: 'Owners Table',
        link: '/pages/tables/owner-table',
      },
      {
        title: 'Locations Table',
        link: '/pages/tables/location-table',
      },
      {
        title: 'Equipments Table',
        link: '/pages/tables/equipment-table',
      },
      {
        title: 'Services Table',
        link: '/pages/tables/service-table',
      },
      {
        title: 'Types Table',
